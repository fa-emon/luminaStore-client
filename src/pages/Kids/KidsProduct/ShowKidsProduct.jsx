...
const ShowKidsProduct = ({ kidsData }) => {
    ...
    return (
        <div className="card bg-[#F3FCE4] shadow-xl mb-20">
            ...
            <Button onClick={() => handleSeeDetails(kidsData._id)} className='bg-[#e9e9e9] hover:bg-[#CBE8EE] text-[#585858] hover:text-black rounded-b-md px-2 py-2'>
...
export default ShowKidsProduct;