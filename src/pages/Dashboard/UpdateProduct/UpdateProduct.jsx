...
const UpdateProduct = () => {
    ...
    const {image, category, new_price, old_price, short_description} = products;
    ...
    const onSubmit = (data) => {
        ...
        axiosSecure.patch(`/clothes/category/${products._id}`, newData)
            .then(data => {
    ...
    return (
        <>
            <div className="flex items-center justify-center w-full">
                ...
                <p className="text-center text-[#202020] text-5xl heading-font"> <span className="text-white">UPDATE A</span>  PRODUCTS</p>
                <img
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="flex w-full gap-6 mb-6">
                        ...
                        <div className="w-full">
                            ...
                            <div className="">
                                <select className="w-full py-2 px-4 rounded-md bg-[#202020] text-[#CBE8EE]" {...register("category", { required: true })} defaultValue={category}>
                    ...
                    <div className="mb-6">
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full">
                                <textarea className="textarea bg-[#202020] text-[#CBE8EE] w-full textarea-md" placeholder="Product Details" {...register("short_description", { required: true })} defaultValue={short_description}></textarea>
                    ...
                    <div>
                        <input className="btn btn-outline bg-[#CBE8EE] text-black hover:text-white hover:bg-black uppercase btn-sm w-full border-[#202020]" type="submit" value="update product" />
                    </div>
                </form>
            </div>
        </>
