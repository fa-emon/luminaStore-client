...
const ShowAllData = ({ popularCollection }) => {
    const navigate = useNavigate();
    const { image, short_description, old_price, new_price } = popularCollection;
    ...
    return (
        <div className="card bg-[#F3FCE4] shadow-xl mb-20">
            ...
            <Button onClick={() => handleSeeDetails(popularCollection._id)} className='bg-[#e9e9e9] hover:bg-[#CBE8EE] text-[#585858] hover:text-black rounded-b-md px-2 py-2'>
